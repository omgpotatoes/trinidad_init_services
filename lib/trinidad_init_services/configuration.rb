...
module Trinidad
  module InitServices
    class Configuration
      ...
      def initialize_paths(jruby_home = default_jruby_home, custom_classpath = nil)
        ...
        @classpath << custom_classpath if custom_classpath
      end
      ...
      def configure(defaults = {})
        ...
        initialize_paths(@jruby_home, defaults['classpath'])
